...
@endif
<div class="container">
<a href="/vehicledrivershome"  class="btn btn-success">Home</a><br>

    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">AddNewVehicleDriver</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/vehicledrivers') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('drivercode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="drivercode" type="text" class="form-control" name="drivercode" value="{{ old('drivercode') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('driverdesc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="driverdesc" type="text" class="form-control" name="driverdesc" value="{{ old('driverdesc') }}" required autofocus>
