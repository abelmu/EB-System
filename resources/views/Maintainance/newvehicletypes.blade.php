    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">AddNewVehicleTypes</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/vehicletypes') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('vehiclecode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="vehiclecode" type="text" class="form-control" name="vehiclecode" value="{{ old('vehiclecode') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('vehicletype') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="vehicletype" type="text" class="form-control" name="vehicletype" value="{{ old('vehicletype') }}" required autofocus>
