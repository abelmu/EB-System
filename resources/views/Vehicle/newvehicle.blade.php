...
<a href="/vehiclehandover"  class="btn btn-success">Home</a><br>
    ...
    <div class="row">
     <form class="form-horizontal" role="form" method="POST" action="{{ url('/vehiclehandovers') }}">

               <div class="col-md-4 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Vehicle External Part Information</div>
...
<div class="col-md-4 col-md-offset-2">
 ...
 <div class="form-group{{ $errors->has('employeename') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="employeename" type="text" class="form-control" name="employeename" value="{{ old('employeename') }}" required autofocus
                                >
     ...
     <div class="col-md-4 col-md-offset-2">
                ...
                <div class="form-group{{ $errors->has('rol') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="numofwrench" type="text" class="form-control" name="numofwrench" value="{{ old('numofwrench') }}" required autofocus
                                >
                   ...
                   <div class="panel-body">
                       ...
                       <div class="form-group{{ $errors->has('flsidetyretype') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="flsidetyretype" type="text" class="form-control" name="flsidetyretype" value="{{ old('flsidetyretype') }}" required autofocus
                                >
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="frsidetyretype" type="text" class="form-control" name="frsidetyretype" value="{{ old('frsidetyretype') }}" required autofocus
                                >
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="rlsidetyretype" type="text" class="form-control" name="rlsidetyretype" value="{{ old('rlsidetyretype') }}" required autofocus
                                >
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="rrsidetyretype" type="text" class="form-control" name="rrsidetyretype" value="{{ old('rrsidetyretype') }}" required autofocus
                                >
